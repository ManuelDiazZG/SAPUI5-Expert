sap.ui.define([
    ...
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        var oMockServerInterface = {
                /**
                 * Initializaes the mock server asynchronously
                 * @protected
            ...
            init: function (oOptionsParameter) {
                ...
                return new Promise(function(fnResolve, fnReject){
                    ...
                    oManifestModel.attachRequestCompleted(function(){
                        ...
                        var oMainDataSource = oManifestModel.getProperty("/sap.app/dataSources/mainServiceD");
                        var sMetadateUrl = sap.ui.require.toUrl(_sAppPath + oMainDataSource.settings.localUri);
                        ...
                        //configyure mock server with the given options or a default delay of 0.5s
                        MockServer.config({
                            autoRespond: true,
                            autoRespondAfter : (oOptions.delay || oUriParameters.get("serverDelay") || 500)
                        });
                        //simulate all requests using mock data
                        oMockServer.simulate(sMetadateUrl, {
                            ...
                            if(oOptions.metadataError || oUriParameters.get("metadataError")){
                                aRequests.forEach(function(aEntry){
                                    if(aEntry.path.toString().indexof("metadata") > -1){
                                        fnResponse(500, "metadataError", aEntry);
                                    }
                                });
                            };
                            ...
                            //set requests and start sthe server
                    ...
                    oManifestModel.attachRequestFailed(function(){
                        var sError = "Failed to load the applicaction manifest";
                        Log.error(sError);
